...
此外，我也是一名编程自媒体创作者，热衷分享技术干货，全网粉丝已超 40,000+ 人。
...
#### BearPassword：简洁、安全、专业的全栈密码管理方案，桌面端 + 浏览器扩展一体协同
BearPassword 是我独立设计并完整落地的一套密码管理产品，覆盖 Electron 桌面端、Chrome/Edge 浏览器扩展、Java 后端服务与产品官网，形成从账号注册、保险库管理到网页自动填充的完整闭环。用户可在桌面端集中管理登录信息、银行卡、证件、服务器连接等各类敏感数据，并在浏览器中一键填充账号密码；同时支持 TOTP 两步验证码的本地生成、展示与复制，兼顾安全与日常使用效率。

在安全架构上，BearPassword 采用客户端加密、服务端仅存密文的设计思路：主密码与保险库内容在设备端加密后再同步，扩展通过本机安全通道向已解锁的桌面端请求数据，而非在浏览器中重复暴露主密码。产品还支持自动锁定、剪贴板定时清空、生物识别解锁等隐私保护能力。

#### 开源项目
我相信最好的学习方式就是动手实践！在大学期间创建多个开源项目，这些系统已全部免费开源在我的 Github！
